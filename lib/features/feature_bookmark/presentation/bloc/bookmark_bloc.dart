...
import 'package:feature_weather/features/feature_bookmark/presentation/bloc/save_city_status.dart';
...
class BookmarkBloc extends Bloc<BookmarkEvent, BookmarkState> {
  ...
  BookmarkBloc({required this.getCityUseCase, required this.saveCityUseCase,
      required this.getAllCityUseCase, required this.deleteCityUseCase})
      : super(BookmarkState(
