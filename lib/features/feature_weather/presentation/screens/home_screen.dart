import 'package:feature_weather/core/widgets/dot_loading_widget.dart';
import 'package:feature_weather/features/feature_weather/domain/use_cases/get_suggestion_city_usecase.dart';
...
import '../widgets/forcast_weather_view.dart';
import '../widgets/last_raw_view.dart';
          ...
          children: [
            ...
            BlocBuilder<HomeBloc,HomeState>(
              ...
              builder: (context, state){
                                  ...
                                  print(DateConverter.changeDtToDateTimeHour(166012786, 0));
                  ...
                  return Expanded(
                      child: ListView(
                        children: [
                          ...
                          /// last Row
                          LastRowView(height: height, currentCityEntity: currentCityEntity, sunrise: sunrise, sunset: sunset),
